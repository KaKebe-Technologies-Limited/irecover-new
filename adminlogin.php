...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("SELECT user_name, password FROM admins WHERE user_name = ? AND role IN ('super_admin','admin')");
    if ($stmt) {
...
<head>
    ...
    <title>Admin Login — iRecovery Uganda</title>
    <meta name="description" content="Administrator login for iRecovery Uganda — the document recovery platform's management console.">
